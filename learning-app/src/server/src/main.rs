...
fn handle_connection(mut stream: TcpStream) {
    ...
    if method == "POST" && path =="http://localhost:7878"{
    ...
    let contents_result = fs::read_to_string("C:/All for Kolpriks/Study Folder/Mobiles-Project/Learning-App/learning-app/public/index.html");
